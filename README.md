...
- Networking: Networking support through use of [Netavark](https://github.com/containers/netavark) and [Aardvark](https://github.com/containers/aardvark-dns).  Rootless networking is handled via [pasta](https://passt.top/passt/about/) (by default) or [slirp4netns](https://github.com/rootless-containers/slirp4netns).
